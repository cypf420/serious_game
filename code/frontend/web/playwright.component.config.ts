...
export default defineConfig({
  testDir: "./e2e",
  testMatch: ["component-game-shell.spec.ts", "tutorial.spec.ts", "action-semantics.spec.ts", "punctuation.spec.ts", "archive-history.spec.ts", "retired-overtime.spec.ts", "budget-sync.spec.ts", "contract-tutorial.spec.ts", "ending.spec.ts"],
  fullyParallel: false,
  workers: 1,
  retries: 0,
  reporter: "line",
